...
def build_binary_tree() -> BinaryTree:
    ...
    leftnode.left = BinaryTree._Node(17)
    leftnode.left = BinaryTree._Node(9)

    rightnode.right = BinaryTree._Node(6)
    """
    tree = BinaryTree()
...
def build_perfect_binary_tree() -> BinaryTree:
    ...
    leftnode.left = BinaryTree._Node(17)
    leftnode.right = BinaryTree._Node(9)
    rightnode.left = BinaryTree._Node(3)
    rightnode.right = BinaryTree._Node(6)
