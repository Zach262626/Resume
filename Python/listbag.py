...
class ListBag:
    ...
    def grab(self) -> any:
        ...
        if len(self._elems) == 0:
            ...
            removed_value = random.randint(1, 4)
            self._elems.remove(removed_value)
    ...
    def __add__(self, other: 'ListBag') -> 'ListBag':
        ...
        """
        if (isinstance(other, ListBag) != True):
            raise TypeError("can only concatenate ListBag toListBag")
        else:
            new_elems = self._elems + other._elems
            return ListBag(new_elems)
    ...
    def __eq__(self, other: 'ListBag') -> bool:
        ...
        if (isinstance(other, ListBag) != True):
            ...
            if sorted(self._elems) == sorted(other._elems):
                return True
            else:
                return False
